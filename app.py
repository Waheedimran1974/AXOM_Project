...
if uploaded_file:
    ...
    with st.expander("View Full Terms of Service"):
        ...
        **2. Accuracy** Results are generated by the AXOM Neural Engine and do not constitute an official certification from any formal examination board.
        
        **3. Data Privacy** PDF files are processed in real-time and are not stored permanently on our servers.
        
        **4. Processing Agreement** By proceeding, you agree to the 30-second analysis gate required for senior-level script evaluation.
        """)
    
    tos_agreed = st.checkbox("I have read and agree to the Terms of Service")

    # Analysis button remains disabled until checkbox is ticked
